...
**V5 时间外（bw ≥ 500 Mbps + 评估侧 winsorize，默认口径；n=33,484）：**
| 指标 | RJ 基线 | 采用配置 | 变化 |
|---|---:|---:|---|
| 矿主 RMSE / R² | 0.03213 / 0.20468 | **0.03084 / 0.26735** | RMSE −4.0%，R² **+0.063** |
| 平台 RMSE / R² | 0.02510 / 0.04925 | 0.02525 / 0.03728 | RMSE +0.6%，R² −0.012 |
| 90% 区间覆盖（矿主/平台） | — | 0.896 / 0.905 | 达标 |
...
**8 窗滚动回测（默认口径）**：矿主 R² 均值 0.392 / 最差 0.261；平台 0.096 / 0.027。
